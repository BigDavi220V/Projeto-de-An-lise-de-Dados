...
group by professional_status; -- usando subquery no from
...
from sales.customers
group by professional_status; -- sem usar nenhuma subquery
...
order by sto.store_name, fun.visit_page_date, visitas_acumuladas desc;
-- RESUMO ##########################################################################
