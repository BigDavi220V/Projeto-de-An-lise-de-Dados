...
select distinct first_name
from sales.customers
where first_name like 'ANA%' -- o % depois do nome indica pesquisar
-- os nomes que vem depois de ana

select distinct first_name
from sales.customers
where first_name like '%ANA' -- o % antes do nome indica que pesquisa os
--nomes antes de ana.

select distinct first_name
from sales.customers
where first_name like '%ANA%' -- o % antes e depois indica pesquisar os nome
-- que são antes de depois de ana.
