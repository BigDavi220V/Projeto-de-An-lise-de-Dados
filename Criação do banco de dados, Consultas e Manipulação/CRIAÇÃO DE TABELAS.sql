...
SELECT 
	customer_id, 
	datadiff('y',birth_date, current_date) as idade_do_cliente
		INTO temp_tables.customers_ag -- INTO > usado para criar uma nova tabela a partir de uma já existente.
FROM sales.customers;

select * from temp_tables.customers_ag; -- A nova tabela criada.
