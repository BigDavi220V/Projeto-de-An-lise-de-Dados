...
/*
CREATE FUNCTION datadiff(unidade varchar, data_inicial date, data_final date)
returns integer
language sql
				as
			$$
			...
			$$*/ -- Já está criado. (OBS: uma vez a função criada não precisa criar novamento, pois está na memoria do SGBD).

select datadiff('y','2023-05-14', current_date);

-- (Exemplo 2) Delete a função DATEDIFF criada no exercício anterior

DROP function datadiff; -- deleta a função criada. Já está deletado.
